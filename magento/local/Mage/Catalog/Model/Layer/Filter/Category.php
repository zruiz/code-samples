...
class Mage_Catalog_Model_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            //print_r($categoty->getChildrenCategories());die();
			$categories = $categoty->getChildrenCategories();
			//$categories = $categoty->getParentCategory()->getChildrenCategories();
			if (!$categoty->getId() or $categoty->getId() == 3 or $categoty->getId() == 4 or $categoty->getId() == 7 or $categoty->getId() == 8) {
              $categories = Mage::getModel('catalog/category')->getCollection()
                ->addAttributeToSelect('name')
                ->addAttributeToFilter('is_active', 1)
                //->addFieldToFilter('entity_id', array('eq' => $categoty->getId()))
			...
			/** $categories = Mage::getModel('catalog/category')->getCollection()
				...
				->addFieldToFilter('entity_id', array('neq' => 548)); **/
